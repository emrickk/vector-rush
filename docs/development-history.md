...
Final native recording completes a 43.029-second lap. The foreground three-lap race passes with six finishers, zero recoveries, frozen results, pause and restart checks. Its P95/P99/max delivered frames are 9.025/9.317/9.400 ms. The logged surface changed to 3326×2104, so this is not a controlled 1080p benchmark. Retained the earlier unfocused rival-timeout failure; no unrelated handling/lifecycle change or causal claim. [Full milestone and native comparisons](current-game/night-city-2026-09-17/README.md). Wrapper now selects Stage 7 and offers `p4-build` for preserved Stage 6. Owner artistic and manual/controller acceptance remain open. The owner approved committing and pushing this milestone on September 17, 2026.

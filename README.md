...
- **Current candidate:** `UnityProject/Assets/Scenes/AnimatedBillboardsStage6.unity` — animated video ads in sparse architectural clusters, varied heights and orientations, and corrected screen flicker. Haze, rain and the dry tunnel are preserved. Prior scenes are retained.
...
[Latest native billboard comparison](docs/current-game/billboards-2026-09-17/opening-comparison.jpg) · [Approved direction reference](docs/current-game/evidence/underground-descent-reference.png) · [Public repository](https://github.com/emrickk/vector-rush)

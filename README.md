...
- **Current candidate:** `UnityProject/Assets/Scenes/AnimatedBillboardsStage6.unity` — larger animated video ads placed for driving visibility in sparse architectural clusters, with varied heights/orientations and corrected screen flicker. Haze, rain and the dry tunnel are preserved. Prior scenes are retained.
...
[Latest native billboard comparison](docs/current-game/billboard-readability-2026-09-17/comparison.jpg) · [Approved direction reference](docs/current-game/evidence/underground-descent-reference.png) · [Public repository](https://github.com/emrickk/vector-rush)

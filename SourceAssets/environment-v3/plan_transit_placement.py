...
with open(os.path.join(OUT,'asset-stats.json')) as f:assets=json.load(f)
...
placements=[audit('Nocturne_TransitStation_A',.918,33,-7),audit('Nocturne_ServiceWorkshop_A',.948,-29,-3,True)]
...
runtime_candidates=[
 course_candidate('exit transit station',.918,33,-7,(11.6,32)),
 course_candidate('opposite low service room',.948,-29,-3,(4,9),180),

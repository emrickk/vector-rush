...
contract['render_resume']={'reason':'CPU OIDN denoiser delayed output; same saved geometry and lighting resumed without denoising','denoising':False,'samples':32,'threads':4,'existing_01_samples':48,'priority':'side, top, chase first; existing images preserved'}
...
ordered=sorted(contract['views'],key=lambda v: {'08':0,'07':1,'05':2,'06':3,'02':4,'03':5,'04':6,'09':7,'10':8,'01':9}.get(v[0][:2],99))

...
namespace VectorRush.Tests
{
    public sealed class ProductionBoundaryTests
    {
        ...
        public void ProductionSceneSetupExposesAllBatchEntrypoints()
        {
            ...
            foreach (string method in new[] { "ExportContext", "ImportArt", "PrepareExperienceScene", "UpgradeExperienceScene", "BuildScene", "BakeScene", "BuildCandidate", "BuildExperienceCandidate" })

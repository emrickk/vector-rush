...
task_scene="Assets/Scenes/NightCityStage7.unity"
...
case "${1:-help}" in
  ...
  test)
    ...
    ;;
  *) echo 'Usage: bash tools/current-game.sh open | build <fresh absolute .app> <fresh absolute evidence> | p4-build <app> <evidence> | baseline-build <app> <evidence> | test [fresh absolute directory]' ;;
esac

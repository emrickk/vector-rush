...
task_scene="Assets/Scenes/UndergroundGalleryStage2.unity"
...
case "${1:-help}" in
  ...
  test)
    ...
    ;;
  *) echo 'Usage: bash tools/current-game.sh open | build <fresh absolute .app> <fresh absolute evidence> | baseline-build <app> <evidence> | test [fresh absolute directory]' ;;
esac
